...
class CInputstreamTypeFM : public IInputstreamType
{
public:
  CInputstreamTypeFM(std::shared_ptr<SETTINGS::CSettings> settings,
  ...
  std::string_view GetName() const override { return "FM radio"; }
