...
class CInputstreamTypeHD : public IInputstreamType
{
public:
  CInputstreamTypeHD(std::shared_ptr<SETTINGS::CSettings> settings,
  ...
  std::string_view GetName() const override { return "HD radio"; }
